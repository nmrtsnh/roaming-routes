...
const Newsletter = () => {
  ...
  return (
    <div className={`bg-[#FFF8E3] p-10 ${isVisible ? "visible" : "hidden"}`}>
      <div className="sm:w-fit mx-auto bg-white p-10 rounded-lg shadow-md newsletter-animation ">
        ...
        <form
          action="#"
          method="post"
          className="flex sm:flex-row flex-col gap-2 items-end"
        >
          <input
            type="email"
            name="email"
            id="email"
            className="sm:w-96 w-56 border rounded py-2 px-3 mr-2 focus:outline-none focus:border-blue-500"
